 ...
 * @author ACER
 */
public class RoomAssetDTO implements Serializable{
    private int status;
    private int id;
    private int idRoom;
    ...
    public RoomAssetDTO(int id, int idRoom, String nameRoom, int idAsset, String nameAsset, String typeAsset, int priceAsset) {
        this.id = id;
        this.idRoom = idRoom;
